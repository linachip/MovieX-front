...
//         movies.map(async (movie) => {
//           const response = await axios.get(
//             `https://api.themoviedb.org/3/search/movie?api_key=${API_KEY}&language=en-US&query=${movie.title}&page=1&include_adult=false`
//           );
...
const Recognition = (props) => {
  ...
  //     });
  //     // response.headers.set("Authorization", `Bearer ${sessionStorage.getItem("accessToken")}`)
